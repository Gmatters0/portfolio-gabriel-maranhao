...
// lucide-react removeu os ícones de marca (GitHub/LinkedIn) a partir da v1 — usamos os
// glifos oficiais como SVG local para manter o mesmo tratamento visual dos demais ícones.
